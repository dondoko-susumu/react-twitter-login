            ...
            if (window.opener) {
                ...
                window.onmessage = function (_a) {
                    ...
                    return __awaiter(_this, void 0, void 0, function () {
                        var accessTokenData, account, result_1, popup_1;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    if (!(type === "authorized")) return [3, 3];
                                ...
                                case 1:
                                    accessTokenData = _c.sent();
                                    return [4, oauth1_1.obtainTwitterAccount({
                                ...
                                case 2:
                                    account = _c.sent();
                                    result_1 = __assign(__assign({}, accessTokenData), account);
                                    popup_1 = this.state.popup;
                                    this.setState({
                                        isCompleted: true
                                    }, function () {
                                        authCallback_1 && authCallback_1(undefined, result_1);
